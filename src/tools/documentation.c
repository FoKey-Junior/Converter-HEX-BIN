...
void help_documentation() {
    printf(
        ...
        "Description:\n"
        "  The utility converts files between ASCII HEX and binary formats\n"
        ...
        "Options:\n"
        "  -a    Convert the input HEX file to a binary file\n"
        "        Example:\n"
        "          text.hex -a  text.bin\n\n"
        "  -b    Convert the input binary file to a HEX file\n"
        "        Example:\n"
        "          text.bin -b  text.hex\n\n"
